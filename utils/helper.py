...
def extract_receipt_tenant_info(ocr_text, system_prompt, model_name, instructor_client=instructor_client):
...
def extract_receipt_item_info(ocr_text, system_prompt, model_name, instructor_client=instructor_client):
    if '3.5' in model_name.lower():
        try:
...
def extract_receipt_payment_info(ocr_text, system_prompt, model_name, instructor_client=instructor_client):
